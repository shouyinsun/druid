...
public class ServerManager implements QuerySegmentWalker
{
  ...
  )
  {
    ...
    return CPUTimeMetricQueryRunner.safeBuild(//用于收集"query/cpu/time"
        new SpecificSegmentQueryRunner<T>(//用户修改执行线程名
            new MetricsEmittingQueryRunner<T>(
                ...
                new BySegmentQueryRunner<T>(
                    ...
                    new CachingQueryRunner<T>(//为结果添加缓存
                        segmentId,
                        segmentDescriptor,
                        objectMapper,
                        cache,
