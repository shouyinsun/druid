...
public interface Sequence<T>
{
  ...
  /***
   * accumulate()方法完成聚合运算
   * 方法调用时传入一个累计器(Accumulator)
   * Accumulator将迭代过程中进行的聚合运算抽取到accumulate()方法中
   * **/
 ...
 /**
   ...
   */
    ...
    /****
     * toYielder() 将Sequence转换为成Yielder
     * Yielder对象可以看作是一个链表 调用Yielder的get方法获取当前元素的值,next方法获取下一个Yielder对象
     * toYielder()方法需要传入一个YieldingAccumulator,跟Yielder协同工作实现 中断/执行操作
     */
